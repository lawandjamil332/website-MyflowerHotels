...
export function WhatsAppButton({ phone, label }: { phone?: string | null; label: string }) {
  ...
  return (
    <a
      ...
      aria-label={label}
      className="fixed bottom-5 end-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition hover:scale-105 focus-visible:ring-2 focus-visible:ring-stone-900 focus-visible:ring-offset-2 md:hidden"
    >
