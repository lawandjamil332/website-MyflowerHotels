...
/** Solid charcoal pill. The one thing on a light section meant to be pressed. */
...
/**
 * Outlined in the same charcoal, for the secondary action beside it.
 *
...
/** Sits on a photograph or on the near-black footer. */
