...
const base =
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded text-[0.9rem] font-bold leading-none transition-all duration-300 ease-luxe focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50'

/** Solid blue. The one thing on a light section that is meant to be pressed. */
export const btnPrimary = `${base} bg-brand px-7 py-3.5 text-white hover:bg-brand-bright focus-visible:ring-brand focus-visible:ring-offset-bone`

/** Outlined in the same blue, for the secondary action beside it. */
export const btnOutline = `${base} border border-brand bg-bone px-7 py-3.5 text-brand hover:bg-sand focus-visible:ring-brand focus-visible:ring-offset-bone`

/** Sits on a photograph or on the navy footer. */
export const btnOnDark = `${base} border border-white/70 px-7 py-3.5 text-white hover:border-white hover:bg-white hover:text-ink focus-visible:ring-white focus-visible:ring-offset-transparent`

/** Filled light button on a dark ground — the primary action over a hero. */
export const btnLight = `${base} bg-white px-7 py-3.5 text-brand hover:bg-sand focus-visible:ring-white focus-visible:ring-offset-transparent`

/** WhatsApp keeps its own colour: guests recognise it faster than any label. */
export const btnWhatsApp = `${base} bg-whatsapp px-7 py-3.5 text-white hover:brightness-95 focus-visible:ring-whatsapp focus-visible:ring-offset-bone`

/** Compact variant for cards and sidebars where a full-height button crowds. */
export const btnSmall = 'px-5 py-2.5 text-[0.82rem]'
